...
| accounts | 404.html | ![screenshot](documentation/validation/404.png) | |
### CSS
...
| Browser | Home | Contact | Register | Sign In | Make Res | Profile | Edit Res | Cancel Res | Delete Res | Sign Out | 404 | Result |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | 
...
| | Flavors modal close Button is expected to close the modal when the user clicks on it | Tested the feature by doing clicking on the buttom | The feature behaved as expected, and closed when clicked | Test concluded and passed | ![screenshot](documentation/features/mod_fla.png) |
| | Village Pop Up modal Close Button is expected to close the modal when the user clicks on it | Tested the feature by doing clicking on the buttom | The feature behaved as expected, and closed when clicked | Test concluded and passed | ![screenshot](documentation/features/mod_cate.png) |
| | How to Book Close Button modal is expected to close tho modal when the user clicks on it | Tested the feature by doing clicking on the buttom | The feature behaved as expected, and closed when clicked | Test concluded and passed | ![screenshot](documentation/features/mod_book.png) |
| | How to Book modal Logged in link is expected to open the loggon page when the user clicks on it | Tested the feature by doing clicking on the link | The feature behaved as expected, and opened when clicked | Test concluded and passed | ![screenshot](documentation/features/logged.png) |
| | How to Book modal Register link is expected to open the Register page when the user clicks on it | Tested the feature by doing clicking on the link | The feature behaved as expected, and opened when clicked | Test concluded and passed | ![screenshot](documentation/features/register_link.png) |
| | How to Book modal Make Reservation link is expected to open the Reservation page when the user clicks on it | Tested the feature by doing clicking on the link | The feature behaved as expected, and opened when clicked | Test concluded and passed | ![screenshot](documentation/features/make_reservation_link.png) |
| | Social Media links are expected to open their pages when the user clicks on them | Tested the feature by doing clicking on the link | The feature behaved as expected, and opened when clicked | Test concluded and passed | ![screenshot](documentation/features/social.png ) |
| Contact | | | | | |
...
| 404 | |
| | 404 is expected to direct user to 404 page when an invalid page is entered. | Tested the feature by doing filling out  entering an invalid page. | The feature behaved as expected, and it directed to 404 page. | Test concluded and passed | ![screenshot](documentation/responsiveness/tablet_404.png) | |
| Messages | |
